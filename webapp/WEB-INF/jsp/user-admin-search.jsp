...
<div class="x-body">
    ...
    <div class="layui-row">
        <form id="searchForm" class="layui-form layui-col-md12 x-so">
            ...
            <button class="layui-btn" onclick="x_admin_show('','${pageContext.request.contextPath}/user/selectByName')"><i class="layui-icon">&#xe615;</i></button>
        </form>
    </div>
    <xblock>
        <span class="x-right" style="line-height:40px">共有数据：${search.size()} 条</span>
    </xblock>
