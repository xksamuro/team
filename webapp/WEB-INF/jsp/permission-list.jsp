...
<html lang="en">
  ...
  <body>
    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="${pageContext.request.contextPath}/searchpermission">
        ...
        <c:forEach items="${permissionList.list}" var="role">
          <tr>
            ...
            <td class="td-manage">
              ...
              <a onclick="x_admin_show('分配菜单','${pageContext.request.contextPath}/user/toallocateRole/${user.id}',600,400)" title="分配菜单" href="javascript:;">
                <i class="layui-icon">&#xe631;</i>
              </a>
            </td>
          </tr>
    ...
    <script>
        function go(){
            ...
            var reg = /^[1-9]\d*$/;
            var pageCount = '${permissionList.pages}';
            if(reg.test(count)){
                if(count > pageCount){
                    alert("不能大于总页数!!!");
                }else {
