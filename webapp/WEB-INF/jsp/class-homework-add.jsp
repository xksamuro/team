  ...
  <body>
        ...
        <form class="layui-form" id="addForm" method="post" action="">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <textarea id="workcontent" name="workcontent" required lay-verify="workcontent"
                    autocomplete="off" class="layui-input"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <button  type="button" class="layui-btn" id="addHomeWork" lay-filter="add" lay-submit="">
                    保存
                </button>
            </div>
      </form>
    ...
    <script>
        layui.use(['form', 'layer'], function () {
            ...
            form.on('submit(add)', $("#addHomeWork").click(function () {
                    $.post("${pageContext.request.contextPath}/class/addHomeWork",
                        $("#addForm").serialize(),
                        function (data) {
