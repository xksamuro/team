...
<body>
<div class="x-body">
    <form class="layui-form" id="updateForm" method="post" action="${pageContext.request.contextPath}/user/updateUser/${adminList.id}">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="name" name="name" required lay-verify="name"
                       autocomplete="off" class="layui-input" value="${adminList.name}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="username" name="username" required lay-verify="username"
                       autocomplete="off" class="layui-input" value="${adminList.username}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" id="password" name="password" required lay-verify="password"
                       autocomplete="off" class="layui-input" value="${adminList.password}">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="phone" name="phone" required lay-verify="phone"
                       autocomplete="off" class="layui-input" value="${adminList.phone}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="email" name="email" required lay-verify="email"
                       autocomplete="off" class="layui-input" value="${adminList.email}">
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <div class="layui-form-item">
            <button id="updateUser" type="submit" class="layui-btn" lay-filter="update" lay-submit="">
                修改
            </button>
        </div>
    </form>
...
<script>
    ...
    /*form.on('submit(update)', $("#updateUser").click(function () {
